...
2. **Write** — author HTML composition
...
`init` creates the right file structure, copies media, transcribes audio with Whisper, and installs AI coding skills.
...
Reports errors (must fix), warnings (should fix), and info (with `--verbose`).
